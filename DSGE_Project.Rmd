...
<!-- ```{=latex, eval=FALSE} -->
<!-- % 1. Consumption Euler Equation (from FOC_C and FOC_B) -->
...
<!-- \end{equation} -->
<!-- \textit{Interpretation:} Marginal rate of substitution between current and future consumption equals real bond return. Habit formation ($\eta$) and inflation ($P_t/P_{t+1}$) directly affect consumption smoothing. -->

<!-- % 2. Labor Supply (from FOC_h and FOC_C) -->
...
<!-- \end{equation} -->
<!-- \textit{Interpretation:} Real wage equals marginal rate of substitution between consumption and leisure. Habit persistence reduces current consumption's marginal utility, increasing required compensation for labor. -->

<!-- % 3. Money Demand (from FOC_M and FOC_B) -->
...
<!-- \end{equation} -->
<!-- \textit{Interpretation:} Money demand inversely related to nominal interest rate ($R^B_t - 1$). Future consumption marginal utility serves as stochastic discount factor. -->

<!-- % 4. Capital Euler Equation (from FOC_K, FOC_B, and investment adjustment) -->
...
<!-- \text{ (Tobin's q)} -->
<!-- \end{equation} -->
<!-- \textit{Interpretation:} Expected return on capital (including adjustment costs) equals real bond return. Investment adjustment costs ($\phi$) create frictions in capital accumulation. -->
<!-- ``` -->
